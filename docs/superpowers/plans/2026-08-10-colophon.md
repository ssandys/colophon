...
Item {
  ...
  Timer {
    ...
    onTriggered: {
      ...
      // JS engine, and qmllint does not report it -- it exits 255 with NO
      // output at all, so bin/test fails with no diagnostic explaining why.
