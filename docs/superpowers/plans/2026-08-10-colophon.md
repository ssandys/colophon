...
Expected: `"status": "stopped"`, a `clientVersion` of `0.32.6`, and an `installed` list of nine models. This is the command the README tells users to run when something looks wrong.
